...
describe("Testing The Great Henge API resources", () => {
  describe("Testing User and Product data flow", () => {
    ...
    it("Testing login as user", async () => {
      let data = { email: email, password: "holamundo" };
    ...
    it("Testing update to premium", async () => {
      let response = await requester
        .get("/users/prem")
    ...
    it("Testing cart update", async () => {
      let data = {
        product: {
          product: "64dbd0afa30dd5cce4dec11d",
          quantity: 1,
        },
      };
      let response = await requester
    ...
    it("Testing login as admin", async () => {
